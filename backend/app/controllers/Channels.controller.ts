...
class ChannelsController {
  ...
  static async updatePreferences (req: Request, res: Response) {
    ...
    for (const preferenceKey of preferencesKeys) {
      ...
      const hasPaidPreferenceValueChanged = originalPreferences[preferenceKey]?.value !== preference.value
      if (preference.patreonRequired && hasPaidPreferenceValueChanged && !user.admin) {
