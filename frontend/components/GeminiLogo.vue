<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="256" height="258" preserveAspectRatio="xMidYMid" v-bind="$attrs"
        viewBox="0 0 256 258">
        <defs>
            <radialGradient id="a" cx="78.302%" cy="55.52%" r="78.115%" fx="78.302%" fy="55.52%"
            ...
            <radialGradient id="b" cx="-3.409%" cy="-54.219%" r="169.363%" fx="-3.409%" fy="-54.219%"
