<template>
  <aside class="pointer-events-none fixed start-0 top-0 !z-[15] flex h-full xl:z-10 transition-transform duration-300"
    ...
    <div
      class="border-muted-200 pointer-events-auto relative z-10 h-full w-[280px] border-r bg-white dark:bg-black transition-all duration-300">
      <div class="flex h-screen flex-col">
        <div class="relative h-full w-full overflow-y-auto">
          <div
            class="cursor-pointer mx-2 mt-4 bg-gray-100 py-2 mb-4 px-4 border border-gray-300 rounded-md text-gray-600 text-sm font-jost flex items-center dark:bg-gray-800 dark:border-gray-700 dark:text-white"
                ...
                <template v-for="route in c.routes">
                  <li v-if="route.enabled" class="mb-2">
                    <NuxtLink :to="route.to"
                      class="w-full px-2 py-2.5 rounded-md flex items-center gap-6 text-gray-600 hover:bg-blue-50 hover:text-blue-500 transition-colors duration-200 ease-in-out dark:text-white dark:hover:text-white dark:hover:bg-gray-800"
                      active-class="bg-blue-50 !text-blue-500 dark:bg-gray-800 dark:text-white">
